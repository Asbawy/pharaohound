...
[![Version](https://img.shields.io/badge/version-2.0.0-gold.svg)](https://github.com/Asbawy/pharaohound)
...
│   ├── __init__.py                  # v2.0.0 version and package info
...
├── pyproject.toml                   # PEP 517 build config (v2.0.0)
